...
export class KuberClusterStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const ssmManagedInstance = ManagedPolicy.fromAwsManagedPolicyName("AmazonSSMManagedInstanceCore");
    ...
    const zone = HostedZone.fromLookup(this, "HostedZoneLookup", {domainName: "morjoff.com"});
    ...
    const dbClusterSecurityGroup = new SecurityGroup(this, "DBClusterSecurityGroup", {
      vpc: vpc,
      allowAllOutbound: true
    });

    dbClusterSecurityGroup.addIngressRule(Peer.ipv4(vpc.vpcCidrBlock), Port.tcp(3306))
    ...
    const connectionStringSSMParameter = new CfnParameter(this, "K3SConnectionString", {
